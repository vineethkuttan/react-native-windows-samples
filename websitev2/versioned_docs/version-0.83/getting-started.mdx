...
```bat
npx --yes @react-native-community/cli@latest init <projectName> --version "^0.83.0"
```
...
<Tabs>
<TabItem value="yarn" label="Using Yarn (Recommended)">

```bat
yarn add react-native-windows@^0.83.0
```
...
```bat
npm install --save react-native-windows@^0.83.0
```
