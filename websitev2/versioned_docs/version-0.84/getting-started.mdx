...
```bat
npx --yes @react-native-community/cli@latest init <projectName> --version "^0.84.0"
```
...
```bat
yarn add react-native-windows@^0.84.0
```
...
```bat
npm install --save react-native-windows@^0.84.0
```
